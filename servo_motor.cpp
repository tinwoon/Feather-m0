...
SERVO_MOTOR servo_motor{1,0};

SERVO_MOTOR_DATA servo_motor_data{
  set_init,
  get_init,
  set,
  get,
...
static void get_init(int PARAMETER, void* value){
  switch(PARAMETER){
    case PARAMETER_SERVO_MOTOR_GET_INIT:
...
static void set_init(int PARAMETER, void* value){
  switch(PARAMETER){
    case PARAMETER_SERVO_MOTOR_SET_INIT:
...
static void set(int PARAMETER, void* value){
  ...
  switch(PARAMETER){
     case PARAMETER_SERVO_MOTOR_ID :  
      set_para = set_motor_id;
      set_para((int*)value);
      break;
      
    case PARAMETER_SERVO_ANGLE:
      set_para = set_angle;
      set_para((int*)value);
      break;
  }
